...
/**
 * LogicAndGraphPattern represents two graphPatterns connected by AND
 * @author michaelrogger
 */
public class LogicAndGraphPattern implements GraphPattern {
	
	GraphPattern left;
	GraphPattern right;
	
	public LogicAndGraphPattern() {
		super();
	}
